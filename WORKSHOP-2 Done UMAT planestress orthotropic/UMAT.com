...
options = {
    'SIMExt':'.sim',
    'abaquslm_license_file':'27000@lic.rz.tuhh.de',
    'ams':OFF,
    ...
    'cavityTypes':[],
    'cavparallel':OFF,
    'compile_cpp':['cl', '/c', '/W0', '/MD', '/TP', '/EHsc', '/DNDEBUG', '/DWIN32', '/DTP_IP', '/D_CONSOLE', '/DNTI', '/DFLT_LIC', '/DOL_DOC', '/D__LIB__', '/DHKS_NT', '/D_WINDOWS_SOURCE', '/DFAR=', '/D_WINDOWS', '/DABQ_WIN86_64', '%P', '/I%I', '/IC:\\SIMULIA\\EstProducts\\2022', '/Qdiag-disable:10448'],
    'compile_fmu':['win64CmpWrp', '-m64', '-msvc9', 'cl', '/LD', '/D_WINDOWS', '/TC', '/W0', '/I%I', '/IC:\\SIMULIA\\EstProducts\\2022'],
    'compile_fortran':['ifx', '/c', '/fpp', '/extend-source', '/DABQ_WIN86_64', '/DABQ_FORTRAN', '/iface:cref', '/recursive', '/Qauto', '/align:array64byte', '/Qpc64', '/Qprec-div', '/Qfma-', '/fp:precise', '/Qimf-arch-consistency:true', '/Qfp-speculation:safe', '/Qprotect-parens', '/reentrancy:threaded', '/QxSSE3', '/QaxAVX', '/include:%I', '/include:C:\\SIMULIA\\EstProducts\\2022', '%P', '/names:lowercase'],
    ...
    'parval':OFF,
    'pgdHeatTransfer':OFF,
    'plugin_central_dir':'C:\\SIMULIA\\CAE\\plugins\\2022',
    'postOutput':OFF,
    'preDecomposition':ON,
    'restart':OFF,
    'restartEndStep':OFF,
    ...
    'thermal':OFF,
    'tmpdir':'C:\\Users\\asasc\\AppData\\Local\\Temp',
    'tracer':OFF,
    'transientSensitivity':OFF,
    'unfold_param':OFF,
    'unsymm':OFF,
    'user':'PLANESTRESS-ORTHOTROPIC.for',
    'visco':OFF,
    'xplSelect':OFF,
}
